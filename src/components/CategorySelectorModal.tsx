...
export default function CategorySelectorModal({ isOpen, onClose }: CategorySelectorModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-300">
      <div className="relative bg-white rounded-xl shadow-2xl max-w-3xl w-full p-10 border border-gray-200">
        <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Choose a Category</h2>
        ...
        <div className="grid grid-cols-2 gap-6">
          {categories.map((cat) => (
            ...
            >
              ...
              <span className="text-xl font-semibold text-gray-700">{cat.label}</span>
            </button>
          ))}
        </div>
